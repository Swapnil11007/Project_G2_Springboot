...
public class Desert {
	...
	public Desert(int prodId, String desertName, String desertDescription, String desertBrief, String desertPath,
	...
	public String toString() {
		return "Desert [prodId=" + prodId + ", desertName=" + desertName + ", desertDescription=" + desertDescription
				+ ", desertBrief=" + desertBrief + ", desertPath=" + desertPath + ", desertAbout=" + desertAbout
