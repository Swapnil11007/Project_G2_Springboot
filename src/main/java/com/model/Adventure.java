...
public class Adventure {
	...
	public Adventure(int prodId, String adventureName, String adventureDescription, int rating, String adventureBrief,
	...
	public String toString() {
		return "Adventure [prodId=" + prodId + ", adventureName=" + adventureName + ", adventureDescription="
				+ adventureDescription + ", rating=" + rating + ", adventureBrief=" + adventureBrief
				+ ", adventurePath=" + adventurePath + ", adventureAbout=" + adventureAbout + ", adventureAbout1="
				+ adventureAbout1 + ", adventureAbout2=" + adventureAbout2 + ", adventurePrice=" + adventurePrice
				+ ", adventurePrice1=" + adventurePrice1 + ", adventurePrice2=" + adventurePrice2 + "]";
	}
